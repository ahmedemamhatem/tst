...
// === Utility: Toggle "Create" Dropdown Button by Field Logic ===
...
function bind_create_dropdown_watchers(frm) {
    const fieldsToBind = ['custom_tax_id', 'custom_cr_number', 'custom_national_id', 'company_name'];
    fieldsToBind.forEach(fieldname => {
...
// === Utility: Handle Geolocation Errors ===

                ...
                .then(r1 => {
                    if (r1 && r1.message && r1.message.item_code) {
                        ...
                        frappe.db.get_value("Item", item_code, "has_sim")
                            .then(r2 => {
                                if (r2 && r2.message) {
                                    device_row.has_sim = r2.message.has_sim ? 1 : 0;
                                    device_row.item_code = item_code;
...
function render_custom_ui(frm) {
    ...
    let html = `
        <style>
            .plate { display: flex; align-items: center; gap: 8px; padding: 10px 12px; background: #fff; border: 1px solid #e6e7eb; border-radius: 12px; }
            .plate .group { display: flex; gap: 8px; }
            .plate .separator { width: 14px; height: 3px; background: #d0d3db; border-radius: 2px; margin: 0 2px; }
            .plate .cell { width: 50px; height: 50px; }
            .plate .cell input { width: 100%; height: 100%; text-align: center; text-transform: uppercase; font-size: 20px; font-weight: bold; border: 2px solid #cfd3dd; border-radius: 8px; outline: none; }
            .plate .cell input:focus { border-color: #3b82f6; box-shadow: 0 0 0 3px rgba(59,130,246,0.15); }
        </style>
        
        <div class="plate">
            <!-- Letters (3) -->
            <div class="group letters">
                <div class="cell"><input type="text" maxlength="1" placeholder="A"></div>
                <div class="cell"><input type="text" maxlength="1" placeholder="B"></div>
                <div class="cell"><input type="text" maxlength="1" placeholder="C"></div>
            </div>
            ...
            <div class="group numbers">
                <div class="cell"><input type="text" maxlength="1" placeholder="1"></div>
                <div class="cell"><input type="text" maxlength="1" placeholder="2"></div>
                <div class="cell"><input type="text" maxlength="1" placeholder="3"></div>
                <div class="cell"><input type="text" maxlength="1" placeholder="4"></div>
            </div>
        </div>
    `;
    ...
    wrapper.find(".letters input").on("keydown", function(e) {
    ...
    wrapper.find(".numbers input").on("keydown", function(e) {

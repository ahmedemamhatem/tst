...
def execute(filters=None):
    ...
    columns = [
        ...
        {"label": "Purchase Document", "fieldname": "purchase_document_no", "fieldtype": "Link", "options": "Purchase Receipt", "width": 130},
        {"label": "Purchase Date", "fieldname": "creation", "fieldtype": "Date", "width": 110},
        {"label": "Current Warehouse", "fieldname": "warehouse", "fieldtype": "Link", "options": "Warehouse", "width": 130},
        {"label": "Last Delivery Note", "fieldname": "last_delivery_note", "fieldtype": "Link", "options": "Delivery Note", "width": 130},
        {"label": "Last Delivery Date", "fieldname": "last_delivery_date", "fieldtype": "Date", "width": 110},
    ]
